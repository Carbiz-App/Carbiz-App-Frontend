...
export function SiteHeader() {
  return (
    <header className="flex py-5 pr-6  h-(--header-height) shrink-0 items-center gap-2 border-b border-border-gray transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
          ...
          <Button variant="ghost" asChild size="sm" className="hidden sm:flex">
            <>
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-medium capitalize text-base">{user.name}</span>
